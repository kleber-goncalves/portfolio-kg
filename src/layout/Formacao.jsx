...
function Formacao() {
    ...
    return (
        <section ref={sectionRef} className="bg-obsidian w-full h-full p-5 md:p-10 relative overflow-hidden flex flex-col items-center gap-10">
            <div className="flex flex-col items-center gap-10 w-full">
                ...
                <div className="w-full h-full relative overflow-hidden flex flex-col items-center gap-15">
                    <div ref={formationCardRef} className="flex flex-col w-full rounded-3xl border-t-2 border-champagne">
                        <div className="flex flex-col items-start gap-5 w-full rounded-3xl p-5 md:p-10 bg-carbon  border border-graphite">
                            <div className="flex flex-col gap-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <p className="text-xs md:text-3xl text-steel uppercase">Nível auto-avaliado</p>
                                </div>
                            ...
                            <div className="flex flex-col mt-3 gap-5 text-sm md:text-3xl text-steel">
                                <p>
                                    ...
                                    <span className="font-bold text-bronze"> Front-end</span> e<span className="font-bold text-bronze"> Back-end</span> da <span className="text-champagne font-bold">DNC</span>, com formação prática que simula o mercado real e voltada ao desenvolvimento de aplicações web, construção de interfaces, APIs, integração com bancos de dados e desenvolvimento <span className="font-bold text-bronze">Full-Stack</span>.
                                </p>

                                <p>
                                    Atualmente, estou concluindo <span className="font-bold text-bronze">Análise e Desenvolvimento de Sistemas</span> pela <span className="font-bold text-champagne">Uniube — Uberaba</span>, com aproximadamente <span className="font-bold text-bronze">87% da graduação concluída.</span> A formação envolve Scrum, sprints e projetos em equipe. <span className="text-sm md:text-xl text-steel/70 italic">O nível reflete o que a formação entregou, não tempo de mercado.</span>
                                </p>
                            </div>
                            <div className="flex flex-col gap-3 mt-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h3 className="font-bold text-sm md:text-3xl text-steel">FORMAÇÃO</h3>
                                </div>
                                ...
                                <div className="flex justify-between text-sm md:text-xl text-steel">
                                    ...
                                    <span className="text-bronze font-bold">87%</span>
                                </div>

                                <p className="text-sm md:text-xl text-steel">2,5 anos · em conclusão</p>
                            </div>
                            <div className="flex flex-col mt-4 gap-2 text-sm md:text-3xl text-steel">
                                <div className="flex items-center gap-3">
                                    <span className="w-2 h-2 rounded-full bg-champagne"></span>

                                    <h3 className="font-bold ">FORMAÇÕES COMPLEMENTARES</h3>
                                </div>
